...
def main():
    ...
    definir_material(material_id=1, E=338e9)
    ...
    #Genero los nodos
    for n in range(1):
        x, y, z = coordenadas_cartesianas(nodes_iniciales_barras_1[0], nodes_iniciales_barras_1[1], nodes_iniciales_barras_1[2])
        x_1, y_1 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_1[1], nodes_iniciales_barras_1[0], ancho_barras)
        x_2, y_2 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_1[1], nodes_iniciales_barras_1[0], -ancho_barras)
    ...
    for n in range(1):
        x, y, z = coordenadas_cartesianas(nodes_iniciales_barras_2[0], nodes_iniciales_barras_2[1], nodes_iniciales_barras_2[2])
        x_1, y_1 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_2[1], nodes_iniciales_barras_2[0], ancho_barras)
        x_2, y_2 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_2[1], nodes_iniciales_barras_2[0], -ancho_barras)
    ...
    for n in range(1):
        x, y, z = coordenadas_cartesianas(nodes_iniciales_barras_3[0], nodes_iniciales_barras_3[1], nodes_iniciales_barras_3[2])
        x_1, y_1 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_3[1], nodes_iniciales_barras_3[0], ancho_barras)
        x_2, y_2 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_3[1], nodes_iniciales_barras_3[0], -ancho_barras)
    ...
    for n in range(1):
        x, y, z = coordenadas_cartesianas(nodes_iniciales_barras_4[0], nodes_iniciales_barras_4[1], nodes_iniciales_barras_4[2])
        x_1, y_1 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_4[1], nodes_iniciales_barras_4[0], ancho_barras)
        x_2, y_2 = calcular_nuevo_punto_transversal(nodes_iniciales_barras_4[1], nodes_iniciales_barras_4[0], -ancho_barras)
